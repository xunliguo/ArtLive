...
public class SisterActivity extends BaseFragmentActivity implements View.OnClickListener{
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if ("1".equals(jsonObject.getString("state"))) {
                        if (jsonObject.has("data")) {
                            JSONObject data=jsonObject.getJSONObject("data");
                            Intent intent=new Intent(SisterActivity.this,ApplyTwoActivity.class);
