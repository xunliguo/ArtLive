...
public class OutFitPostActivity extends BaseFragmentActivity implements View.OnClickListener,PullToRefreshLayout.OnRefreshListener,LoadRecyclerView.LoadListener,OnItemClickListener<FansBean> {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_out_fit_post);
                    ...
                    if ("1".equals(jsonObject.getString("state"))) {
                        if (jsonObject.has("data")) {
                            ...
                            for (int i=0;i<forum.length();i++){
                                JSONObject jsonObject1=forum.getJSONObject(i);
