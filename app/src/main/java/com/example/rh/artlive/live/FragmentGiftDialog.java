...
public class FragmentGiftDialog extends DialogFragment {
    ...
    private ArrayList<LiveGiftBean> catogarys;
    ...
    private void initView(View rootView) {
        ...
        if(args==null)
            return;
        catogarys=LookActivity.giftBeen;
...
//        }
    ...
    public void initViewPager() {
        ...
        ///定义第一个GridView
        GridView gridView1 = (GridView) layoutInflater.inflate(R.layout.grid_fragment_home, null);
        ...
        ///定义第二个GridView
        GridView gridView2 = (GridView)layoutInflater.inflate(R.layout.grid_fragment_home, null);
...
//        ///定义第三个GridView
//        GridView gridView3 = (GridView) layoutInflater.inflate(R.layout.grid_fragment_home, null);
