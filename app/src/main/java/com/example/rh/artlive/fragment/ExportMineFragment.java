...
public class ExportMineFragment extends BaseFragment implements View.OnClickListener,PullToRefreshLayout.OnRefreshListener,LoadRecyclerView.LoadListener,OnItemClickListener<VoiceBean> {
    ...
    private void initData(){
        ...
        HttpUtil.postHttpRequstProgess(getActivity(), "正在加载", UrlConstant.EXPORTMINE, map, new StringCallback() {
            @Override
    ...
    @Override
    public void onItemClick(ViewGroup parent, View view, VoiceBean noPaiBean, int position) {
