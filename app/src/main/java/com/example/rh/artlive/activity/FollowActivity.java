...
public class FollowActivity extends BaseFragmentActivity implements View.OnClickListener,PullToRefreshLayout.OnRefreshListener,LoadRecyclerView.LoadListener,OnItemClickListener<FansBean> {

    private ImageView mShowDraw;

    private PullToRefreshLayout mAuto;
    private LoadRecyclerView mLoad;
    private FollowAdapter mChestAdapter;
    ...
    private void setAdapter() {
        mChestAdapter = new FollowAdapter(this, R.layout.recycler_fans_adapter, mData);
